...
def registration(request) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        if last_name and first_name and midle_name and phone and email and hashed_password:
            custom_users = CustomUsers()
            custom_users.last_name = last_name
            custom_users.first_name = first_name
            custom_users.midle_name = midle_name
            custom_users.phone = phone
            custom_users.email = email
            custom_users.password = hashed_password
            custom_users.save()
...
# @login_required
def information(request) -> HttpResponse:
    context = {
