# Generated by Django 4.2.18 on 2025-02-12 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='days_of_week', to='accounts.workschedule', verbose_name='Офис')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.userrole', verbose_name='Роль')),
